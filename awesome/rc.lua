...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,    }, "d",
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:bold:pixelsize=28",
...
awful.spawn.with_shell("picom -b")-- -b --config  $HOME/.config/awesome/picom.conf")
